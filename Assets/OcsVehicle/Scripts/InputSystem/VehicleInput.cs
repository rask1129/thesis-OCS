...
//     version 1.11.0
//     from Assets/OcsVehicle/Scripts/InputSystem/VehicleInput.inputactions
//
...
namespace Ocs.Input
{
    ...
    ""controlSchemes"": []
        ...
        ~@VehicleInput()
        {
            UnityEngine.Debug.Assert(!m_Car.enabled, "This will cause a leak and performance issues, VehicleInput.Car.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_Crawler.enabled, "This will cause a leak and performance issues, VehicleInput.Crawler.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_Equipment.enabled, "This will cause a leak and performance issues, VehicleInput.Equipment.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_DumpTruck.enabled, "This will cause a leak and performance issues, VehicleInput.DumpTruck.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_Backhoe.enabled, "This will cause a leak and performance issues, VehicleInput.Backhoe.Disable() has not been called.");
        }
        ...
        private List<ICrawlerActions> m_CrawlerActionsCallbackInterfaces = new List<ICrawlerActions>();
        ...
        public struct CrawlerActions
        {
            ...
            public void AddCallbacks(ICrawlerActions instance)
            {
                if (instance == null || m_Wrapper.m_CrawlerActionsCallbackInterfaces.Contains(instance)) return;
                m_Wrapper.m_CrawlerActionsCallbackInterfaces.Add(instance);
            ...
            private void UnregisterCallbacks(ICrawlerActions instance)
            {
                @RightForward.started -= instance.OnRightForward;
                @RightForward.performed -= instance.OnRightForward;
                @RightForward.canceled -= instance.OnRightForward;
            ...
            public void RemoveCallbacks(ICrawlerActions instance)
            {
                if (m_Wrapper.m_CrawlerActionsCallbackInterfaces.Remove(instance))
                    UnregisterCallbacks(instance);
            }

            public void SetCallbacks(ICrawlerActions instance)
            {
                foreach (var item in m_Wrapper.m_CrawlerActionsCallbackInterfaces)
                    UnregisterCallbacks(item);
                m_Wrapper.m_CrawlerActionsCallbackInterfaces.Clear();
                AddCallbacks(instance);
            }
        }
        ...
        private List<IDumpTruckActions> m_DumpTruckActionsCallbackInterfaces = new List<IDumpTruckActions>();
        ...
        public struct DumpTruckActions
        {
            ...
            public void AddCallbacks(IDumpTruckActions instance)
            {
                if (instance == null || m_Wrapper.m_DumpTruckActionsCallbackInterfaces.Contains(instance)) return;
                m_Wrapper.m_DumpTruckActionsCallbackInterfaces.Add(instance);
                @Work.started += instance.OnWork;
                @Work.performed += instance.OnWork;
                @Work.canceled += instance.OnWork;
            }

            private void UnregisterCallbacks(IDumpTruckActions instance)
            {
                @Work.started -= instance.OnWork;
                @Work.performed -= instance.OnWork;
                @Work.canceled -= instance.OnWork;
            ...
            public void RemoveCallbacks(IDumpTruckActions instance)
            {
                if (m_Wrapper.m_DumpTruckActionsCallbackInterfaces.Remove(instance))
                    UnregisterCallbacks(instance);
            }

            public void SetCallbacks(IDumpTruckActions instance)
            {
                foreach (var item in m_Wrapper.m_DumpTruckActionsCallbackInterfaces)
                    UnregisterCallbacks(item);
                m_Wrapper.m_DumpTruckActionsCallbackInterfaces.Clear();
                AddCallbacks(instance);
            }
        }
        ...
        private List<IBackhoeActions> m_BackhoeActionsCallbackInterfaces = new List<IBackhoeActions>();
        ...
        public struct BackhoeActions
        {
            ...
            public void AddCallbacks(IBackhoeActions instance)
            {
                if (instance == null || m_Wrapper.m_BackhoeActionsCallbackInterfaces.Contains(instance)) return;
                m_Wrapper.m_BackhoeActionsCallbackInterfaces.Add(instance);
            ...
            private void UnregisterCallbacks(IBackhoeActions instance)
            {
                @Lever0.started -= instance.OnLever0;
                @Lever0.performed -= instance.OnLever0;
                @Lever0.canceled -= instance.OnLever0;
            ...
            public void RemoveCallbacks(IBackhoeActions instance)
            {
                if (m_Wrapper.m_BackhoeActionsCallbackInterfaces.Remove(instance))
                    UnregisterCallbacks(instance);
            }

            public void SetCallbacks(IBackhoeActions instance)
            {
                foreach (var item in m_Wrapper.m_BackhoeActionsCallbackInterfaces)
                    UnregisterCallbacks(item);
                m_Wrapper.m_BackhoeActionsCallbackInterfaces.Clear();
                AddCallbacks(instance);
            }
        }
